                        ...
                        <div className="dk-footer-box-info">
                            <Link to="/" onClick={scrollHandler} className="footer-logo">
                                <div className="d-flex justify-content-center">
                                    <img style={{width:"100%"}} src="https://i.ibb.co/594NyV9/logo-black.png" alt="footer_logo" height="160" />
                                </div>
                                
                            </Link>
                            <p className="footer-info-text">
                            With over 20 years of experience, USA Auto Repair provides the best car care. Each service comes with a 1-year or 12,000-mile warranty.
                                </p>
                            ...
                            <Col md={6}>
                                <div className="contact-us">
                                    ...
                                    <div className="contact-info">
                                        <h3>Tangail, Bangladesh</h3>
                                        <p>Tangail Sadar, Tangail-1607</p>
                                    </div>
                                </div>
                            </Col>
                            <Col md={6}>
                        ...
                        <Row>
                            ...
                            <Col md={12} lg={6}>
                                <div className="footer-widget">
                                    ...
                                    <p>
                                    Our family-owned and operated company has been serving Bay Shore and the surrounding areas for the last 10 years. Ask us for FREE estimates!
                                        </p>
                                    <Form>
                                        <Form.Row>
                ...
                <Container>
                    <Row>
                        <Col md={6} className="order-2 order-md-1">
                            <span>Copyright © {new Date().getFullYear()}, All Rights Reserved Autocare</span>
                        </Col>
