...
const OrderList = () => {
    ...
    useEffect(() => {
        axios.get(`https://mighty-coast-60510.herokuapp.com/orders?email=${email}`)
            .then(res => {
                setOrders(res.data);
                setLoading(false);
            })
    ...
    const handleStatusChange = (id, status) => {
        ...
        axios.patch('https://mighty-coast-60510.herokuapp.com/updateOrderStatus', modifiedStatus)
